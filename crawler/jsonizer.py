...
class News:
	...
	def __init__(self, nid = 0, title = "", testata = "", date = "", body = "", feed_url = ""):
...
# def get_body_from_testate(list_news):
# 	for news in list_news:
# 		parser = parserino.ParserTestata(news)
# 	return list_news
...
# 		# Get body news from testate..
# 		list_news = get_body_from_testate(list_news)
